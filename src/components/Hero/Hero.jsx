    ...
    return (
        <div className='hero'>
            ...
            <div className='left-h'>
                ...
                <div className='span'>
                   <span>In here we will help to shape and build your ideal body and live up your life to the fullest</span></div>
                </div>
            ...
            <div className="right-h">
                ...
                <motion.img initial={{right:'11rem'}} whileInView={{right:'20rem'}} transition={transition} src={hero_image_back} alt="" className="hero-image-black"></motion.img>
